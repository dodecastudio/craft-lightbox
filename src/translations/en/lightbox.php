 ...
 */
return [
    "Lightbox plugin loaded" => "Lightbox plugin loaded",

    // Gallery labels detailing the contents of the gallery
    ...
    // Controls
    "PREVIOUS" => "Previous",
    "PREVIOUS_LABEL" => "Previous image in the lightbox",
    "NEXT" => "Next",
    "NEXT_LABEL" => "Next image in the lightbox",
    "CLOSE" => "Close",
    "CLOSE_LABEL" => "Close the lightbox",
